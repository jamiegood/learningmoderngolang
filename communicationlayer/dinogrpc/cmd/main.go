...
func runGRPCServer() {
	...
	fmt.Println("conneting to mongodb")
	// handler, err := databaselayer.GetDatabaseHandler(databaselayer.MONGODB, "mongodb://127.0.0.1") //databaselayer.MONGODB, "mongodb://127.0.0.1")
